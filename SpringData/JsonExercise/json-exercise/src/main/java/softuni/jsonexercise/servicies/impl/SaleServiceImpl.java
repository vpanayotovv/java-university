...
public class SaleServiceImpl implements SaleService {
    ...
    public void seedData() {
        ...
        Sale sale = new Sale();
        sale.setDiscount(5);
        sale.setCar(this.carService.getCarById(ThreadLocalRandom.current().nextLong(1,5)));
        sale.setCustomer(this.customerService.getById(ThreadLocalRandom.current().nextLong(1,5)));

        Sale sale1 = new Sale();
        sale1.setDiscount(10);
        sale1.setCar(this.carService.getCarById(ThreadLocalRandom.current().nextLong(1,5)));
        sale1.setCustomer(this.customerService.getById(ThreadLocalRandom.current().nextLong(1,5)));

        Sale sale2 = new Sale();
        sale2.setDiscount(15);
        sale2.setCar(this.carService.getCarById(ThreadLocalRandom.current().nextLong(1,5)));
        sale2.setCustomer(this.customerService.getById(ThreadLocalRandom.current().nextLong(1,5)));
